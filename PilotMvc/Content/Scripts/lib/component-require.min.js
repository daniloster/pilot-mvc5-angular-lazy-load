var console = ((window.console || console) || { log: function () { } });
var baseUrl = 'http://localhost:44423',
//var baseUrl = 'http://cfgui-dev.m12014.ie', 
//var baseUrl = 'http://cfguidev.mediaonesupport.com', 
    appSettings = {
        angularjsv: '1.2.27'/*1.2.9*//*1.2.27*/, 
        applyForAllDocument: false,
        handleRoutes: false,
        ngBust: (new Date()).getTime()
    };
var requirejs = {
    baseUrl: baseUrl + '/Content/Scripts',
    enforceDefine: true,
...
(e.addEventListener("load",b.onScriptLoad,!1),e.addEventListener("error",b.onScriptError,!1)),e.src=d,J=e,D?y.insertBefore(e,D):y.appendChild(e),J=null,e;if(ea)try{importScripts(d),b.completeLoad(c)}catch(m){b.onError(C("importscripts","importScripts failed for "+c+" at "+d,m,[c]))}};z&&!q.skipDataMain&&T(document.getElementsByTagName("script"),function(b){y||(y=b.parentNode);if(I="main"/*b.getAttribute("data-main")*/)return s=I,q.baseUrl||(E=s.split("/"),s=E.pop(),O=E.length?E.join("/")+"/":"./",q.baseUrl=
