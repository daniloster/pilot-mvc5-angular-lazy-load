(function () {
    var Ctrl = null;
    define(['app', 'components/common/loading/loadingManager', 'app/resource/resourceService', 'app/shared/optionsService'], function (app) {
        if (Ctrl === null) {
            Ctrl = ['$scope', '$rootScope', '$q', 'ResourceService', 'OptionsService', 'LoadingManager', function ($scope, $rootScope, $q, resourceService, optionsService, loadingManager) {
                ...
                $scope['delete'] = function () {
                    var task = $q.defer();
                    loadingManager.startLoading();
                    resourceService.delete({ id: $scope.deletingItem.Id })
                    .success(function (data) {
                        $rootScope.updateSuccessMessage(data.Message);
                        task.resolve();
                        $scope.search();
