    ...
    define(['angular', 'app'], function (angular, app) {
        if (!loaded) {
            ...
            addCssFile = function (ConfigApp) {
                if (cssAdded.indexOf('/Content/Scripts/components/common/form/customValidation.css') < 0) {
                    ...
                    cssAdded.push('/Content/Scripts/components/common/form/customValidation.css');
                }
            },
