define(['lib/IE/isIE', 'lib/IE/isIE8', 'lib/IE/isIE9', 'lib/IE/isIE11', 'xdomain', 'xhook', 'util/array', 'util/string', 'util/object', 'util/date'], function (isIE, isIE8, isIE9, isIE11, xdomain, xhook) {
    ...
    <script 
        ...
        src="/Content/App/lib/component-require.min.js"></script>
    ...
    */
    ...
    function loadJquery() {
        require(['jq'], function ($) {
            ...
            ////css = '<link href="' + appSettings.baseUrl + '/Content/Styles/bootstrap.min.css?ngBust=' + appSettings.ngBust + '" rel="stylesheet">';
            //head.append(css);

            //css = '<link href="' + appSettings.baseUrl + '/Content/Styles/app.css?ngBust=' + appSettings.ngBust + '" rel="stylesheet">';
            //head.append(css);

            //css = '<link href="' + appSettings.baseUrl + '/Content/Styles/checkbox.css?ngBust=' + appSettings.ngBust + '" rel="stylesheet">';
            //head.append(css);
