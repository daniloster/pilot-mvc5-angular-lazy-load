    ...
    define(['angular', 'app'], function (angular, app) {
        if (!loaded) {
            ...
            app.lazy.directive('pilotPassword', ['ConfigApp', function (ConfigApp) {
                angular.element('body').after(angular.element(ConfigApp.getElementLink('/Content/App/components/common/form/password/style.css')));
                ...
                return {
                    ...
                    templateUrl: ConfigApp.getPath('/Content/App/components/common/form/password/template.html'),
