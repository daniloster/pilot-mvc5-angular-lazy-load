    ...
    define(['angular', 'app'], function (angular, app) {
        if (!loaded) {
            ...
            addCssFile = function (ConfigApp) {
                if (cssAdded.indexOf('/Content/App/components/common/form/customValidation.css') < 0) {
                    angular.element('body').after(angular.element(ConfigApp.getElementLink('/Content/App/components/common/form/customValidation.css')));
                    cssAdded.push('/Content/App/components/common/form/customValidation.css');
                }
            },
            ...
            app.lazy.directive("statusMessage", ['ConfigApp', function (ConfigApp) {
                ...
                angular.element('body').after(angular.element(ConfigApp.getElementLink('/Content/App/components/common/form/statusMessage.css')));
                return {
                    restrict: 'EA',
                    templateUrl: ConfigApp.getPath('/Content/App/components/common/form/statusMessage.html'),
