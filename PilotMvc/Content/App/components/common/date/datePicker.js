    ...
    define(['app'], function (app) {
        if (!loaded) {
            ...
            app.lazy.constant('datePickerConfig', {
                template: '/Content/App/components/common/date/picker.html',
                view: 'date',
            ...
            app.lazy.directive('dateRange', ['ConfigApp', function (ConfigApp) {
                return {
                    templateUrl: ConfigApp.getPath('/Content/App/components/common/date/range.html'),
                    scope: {
                        start: '=',
                        end: '='
                    },
            ...
            app.lazy.directive('dateTime', ['$compile', '$document', '$filter', '$parse', '$timeout', 'dateTimeConfig', 'ConfigApp', function ($compile, $document, $filter, $parse, $timeout, dateTimeConfig, ConfigApp) {
                ...
                angular.element('body').after(angular.element('<link href="' + ConfigApp.getPath('/Content/App/components/common/date/style.css') + '" type="text/css" rel="stylesheet" />'));
