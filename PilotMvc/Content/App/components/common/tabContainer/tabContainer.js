(function () {
    ...
    $routeProvider.when("/prefixRoute/:tabName?", {
        ...
        templateUrl: '/Content/App/path/to/page-with-tabs.html'
    });
    ...
    define(['require', 'angular', 'app', 'components/common/loading/loadingController'], function (require, angular, app, loadingController) {
        if (!loaded) {
            app.lazy.directive("tabContainer", ['ConfigApp', function (ConfigApp) {
                angular.element('body').after(angular.element(ConfigApp.getElementLink('/Content/App/components/common/tabContainer/style.css')));
                return {
                    ...
                    restrict: 'EA',
                    templateUrl: ConfigApp.getPath('/Content/App/components/common/tabContainer/template.html'),
                    scope: {
                        tabs: "=tabContainer",
                        tabIndexDefault: "=?",
                        tabAlignment: "=?"
