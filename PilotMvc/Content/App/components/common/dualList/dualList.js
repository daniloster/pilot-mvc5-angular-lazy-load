    ...
    define(['angular', 'app', 'config/debugger'], function (angular, app) {
        if (!loaded) {
            ...
            app.lazy.directive("dualList", ['ConfigApp', 'Debugger', function (ConfigApp, Debugger) {
                angular.element('body').after(angular.element(ConfigApp.getElementLink('/Content/App/components/common/dualList/style.css')));
                var itemTemplate = ''
                return {
                    restrict: 'EA',
                    templateUrl: function (tElement, tAttrs) {
                        ...
                        tElement.html('');
                        return ConfigApp.getPath('/Content/App/components/common/dualList/template.html');
                    },
