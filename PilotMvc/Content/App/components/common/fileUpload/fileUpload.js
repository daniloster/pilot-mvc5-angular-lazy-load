    ...
    define(['app', 'components/common/loading/loadingController', 'components/common/fileUpload/uploadService'], function (app) {
        if (Element === null) {            
            Element = ['$parse', 'ConfigApp', function ($parse, configApp) {
                angular.element('body').after(angular.element(ConfigApp.getElementLink('/Content/App/components/common/fileUpload/file-style.css')));
                ...
                return {
                    ...
                    restrict: 'EA',
                    templateUrl: configApp.getPath('/Content/App/components/common/fileUpload/file-template.html'),
