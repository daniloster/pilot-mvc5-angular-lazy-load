    ...
    define(['app', 'jq', 'angular', 'bootstrap', 'components/common/textStyleEditor/textStyleEditorController', 'components/common/colorPicker/picker'], function (app, $, angular) {
        if (!loaded) {
            ...
            app.lazy.directive("textStyleEditor", ['ConfigApp', function (ConfigApp) {
                angular.element('body').after(angular.element(ConfigApp.getElementLink('/Content/App/components/common/textStyleEditor/style.css')));

                return {
                    replace: false,
                    controller: "TextStyleEditorController",
                    restrict: 'EA',
                    templateUrl: ConfigApp.getPath('/Content/App/components/common/textStyleEditor/template.html'),
                    scope: {
                        editorId: '@',
                        title: '@',
                        onConfirmEditing: '&?',
