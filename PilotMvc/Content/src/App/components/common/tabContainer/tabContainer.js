(function () {
    ...
    $routeProvider.when("/prefixRoute/:tabName?", {
        ...
        templateUrl: '/$base.app.dest/path/to/page-with-tabs.html'
    });
    ...
    define(['require', 'angular', 'app', 'components/common/loading/loadingController'], function (require, angular, app, loadingController) {
        if (!loaded) {
            app.lazy.directive("tabContainer", ['ConfigApp', function (ConfigApp) {
                angular.element('body').after(angular.element(ConfigApp.getElementLink('/$base.app.dest/components/common/tabContainer/style.css')));
                return {
                    ...
                    restrict: 'EA',
                    templateUrl: ConfigApp.getPath('/$base.app.dest/components/common/tabContainer/template.html'),
                    scope: {
                        tabs: "=tabContainer",
                        tabIndexDefault: "=?",
                        tabAlignment: "=?"
