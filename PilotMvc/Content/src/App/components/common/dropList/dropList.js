    ...
    define(['angular', 'app', 'components/common/form/checkbox/checkbox', 'config/debugger'], function (angular, app) {
        if (!loaded) {
            ...
            app.lazy.directive("pilotDropList", ['ConfigApp', 'Debugger', function (ConfigApp, Debugger) {
                angular.element('body').after(angular.element(ConfigApp.getElementLink('/$base.app.dest/components/common/dropList/style.css')));
                var itemTemplate = ''
                return {
                    restrict: 'EA',
                    templateUrl: function (tElement, tAttrs) {
                        ...
                        tElement.html('');
                        return ConfigApp.getPath('/$base.app.dest/components/common/dropList/template.html');
                    },
