    ...
    define(['angular', 'app', 'config/debugger'], function (angular, app) {
        if (!loaded) {
            ...
            app.lazy.directive("dualList", ['ConfigApp', 'Debugger', function (ConfigApp, Debugger) {
                angular.element('body').after(angular.element(ConfigApp.getElementLink('/$base.app.dest/components/common/dualList/style.css')));
                var itemTemplate = ''
                return {
                    restrict: 'EA',
                    templateUrl: function (tElement, tAttrs) {
                        ...
                        tElement.html('');
                        return ConfigApp.getPath('/$base.app.dest/components/common/dualList/template.html');
                    },
