    ...
    define(['angular', 'app'], function (angular, app) {
        if (!loaded) {
            ...
            app.lazy.directive("pilotCheckbox", ['ConfigApp', function (ConfigApp) {
                angular.element('body').after(angular.element(ConfigApp.getElementLink('/$base.app.dest/components/common/form/checkbox/style.css')));
                return {
                    restrict: 'EA',
                    scope: {
                        pilotCheckboxType: '@',
                    ...
                    templateUrl: ConfigApp.getPath('/$base.app.dest/components/common/form/checkbox/template.html'),
