    ...
    define(['angular', 'app'], function (angular, app) {
        if (!loaded) {
            ...
            app.lazy.directive('pilotPassword', ['ConfigApp', function (ConfigApp) {
                angular.element('body').after(angular.element(ConfigApp.getElementLink('/$base.app.dest/components/common/form/password/style.css')));
                ...
                return {
                    ...
                    templateUrl: ConfigApp.getPath('/$base.app.dest/components/common/form/password/template.html'),
