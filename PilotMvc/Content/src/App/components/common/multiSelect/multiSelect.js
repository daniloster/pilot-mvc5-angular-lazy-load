    ...
    define(['app', 'components/common/form/checkbox/checkbox'], function (app) {
        if (!loaded) {
            ...
            app.lazy.directive("multiSelect", ['ConfigApp', function (ConfigApp) {
                angular.element('body').after(angular.element(ConfigApp.getElementLink('/$base.app.dest/components/common/multiSelect/bootstrap-multiselect.css')));
                return {
                    restrict: 'EA',
                    templateUrl: ConfigApp.getPath('/$base.app.dest/components/common/multiSelect/template.html'),
                    scope: {
