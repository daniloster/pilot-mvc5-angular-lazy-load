    ...
    define(['angular', 'app'], function (angular, app) {
        if (!loaded) {
            app.lazy.directive("fadeCarousel", ['ConfigApp', '$timeout', function (ConfigApp, $timeout) {
                angular.element('body').after(angular.element(ConfigApp.getElementLink('/$base.app.dest/components/common/fadeCarousel/style.css')));
                //var templateElement;

                function getTemplateUrl(elem, attr) {
                    attr.templateElement = elem.html();
                    elem.html('');
                    return ConfigApp.getPath('/$base.app.dest/components/common/fadeCarousel/template.html');
                }
