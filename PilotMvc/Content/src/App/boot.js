(function (window) {
    ...
    var requireConfig = {
        baseUrl: (appSettings.baseUrl == '$base.url' ? '' : appSettings.baseUrl) + '/$base.dest.root/App',
        enforceDefine: true,
        ...
        paths: {
            ...
            'jq': ['https://code.jquery.com/jquery-1.11.1.min', 'lib/jQuery/jquery-1.11.1.min'],
            ...
            'uiRouter': ['//cdnjs.cloudflare.com/ajax/libs/angular-ui-router/0.2.8/angular-ui-router.min', 'lib/angularjs/angular-ui-router.min'],
