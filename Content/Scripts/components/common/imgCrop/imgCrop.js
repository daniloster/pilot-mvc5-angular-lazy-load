        ...
        if (!loaded) {
            ...
            ****/
            ...
            (function () {
                ...
                crop.factory('cropHost', ['$q', '$document', 'cropAreaCircle', 'cropAreaSquare', 'cropEXIF', function ($q, $document, CropAreaCircle, CropAreaSquare, cropEXIF) {
                    /* STATIC FUNCTIONS */
                ...
                crop.directive('imgCrop', ['$timeout', 'cropHost', 'cropPubSub', 'ConfigApp', function ($timeout, CropHost, CropPubSub, configApp) {
                    angular.element('body').after(angular.element('<link href="' + configApp.getPath('/Content/Scripts/components/common/imgCrop/style.css') + '" type="text/css" rel="stylesheet" />'));
                    return {
                        restrict: 'E',
                        scope: {
                            fileInput: '@',
                        ...
                        link: function (scope, element/*, attrs*/) {
                            ...
                            var updateResultImage = function (scope) {
                                var resultImage = cropHost.getResultImageDataURI(scope.areaType !== 'square');
