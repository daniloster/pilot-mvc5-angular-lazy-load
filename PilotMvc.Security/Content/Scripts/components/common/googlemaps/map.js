(function () {
    var loaded = false;
    //http://maps.google.com/maps/api/js?v=3&sensor=false&key=YOUR_KEY
    define(['app', 'components/common/loading/loadingController', 'async!http://maps.google.com/maps/api/js?v=3&sensor=false&language=en&key=AIzaSyD3P5F3Db-z26hGv9OVCSEge6HDfSNZz0M'], function (app) {
        if (!loaded) {
             ...
             */
            /*jshint -W030*/
            app.lazy.service('Attr2Options', ['$parse', 'NavigatorGeolocation', 'GeoCoder', function ($parse, NavigatorGeolocation, GeoCoder) {
             ...
             */
            app.lazy.service('GeoCoder', ['$q', function ($q) {
                return {
                    /**
                     * @memberof GeoCoder
             ...
             */
            app.lazy.service('NavigatorGeolocation', ['$q', function ($q) {
                return {
                    /**
             ...
             */
            app.lazy.service('StreetView', ['$q', function ($q) {
                return {
                    /**
             ...
             */
            /*jshint -W089*/
            app.lazy.directive('bicyclingLayer', ['Attr2Options', function (Attr2Options) {
             ...
             */
            /*jshint -W089*/
            app.lazy.directive('cloudLayer', ['Attr2Options', function (Attr2Options) {
                var parser = Attr2Options;
             ...
             */
            /*jshint -W089*/
            app.lazy.directive('customControl', ['Attr2Options', '$compile', function (Attr2Options, $compile) {
                var parser = Attr2Options;
             ...
             */
            /*jshint -W089*/
            app.lazy.directive('dynamicMapsEngineLayer', ['Attr2Options', function (Attr2Options) {
                var parser = Attr2Options;
             ...
             */
            /*jshint -W089*/
            app.lazy.directive('fusionTablesLayer', ['Attr2Options', function (Attr2Options) {
                var parser = Attr2Options;
             ...
             */
            /*jshint -W089*/
            app.lazy.directive('heatmapLayer', ['Attr2Options', '$window', function (Attr2Options, $window) {
                var parser = Attr2Options;
             ...
             *  </map>
             */
            app.lazy.directive('infoWindow', ['Attr2Options', '$compile', '$timeout', function (Attr2Options, $compile, $timeout) {
                var parser = Attr2Options;
             ...
             */
            /*jshint -W089*/
            app.lazy.directive('kmlLayer', ['Attr2Options', function (Attr2Options) {
                var parser = Attr2Options;
             ...
             *    </map>
             */
            app.lazy.directive('mapData', ['Attr2Options', function (Attr2Options) {
                var parser = Attr2Options;
             ...
             */
            /*jshint -W089*/
            app.lazy.directive('mapType', ['Attr2Options', '$window', function (Attr2Options, $window) {
                var parser = Attr2Options;
             ...
             */
            /*jshint -W030*/
            app.lazy.directive('map', ['Attr2Options', '$timeout', function (Attr2Options, $timeout) {
                var parser = Attr2Options;
                ...
                return {
                    ...
                    link: function (scope, element, attrs, ctrl) {
                        ...
                        var initializeMap = function (mapOptions, mapEvents) {
                            ...
                            scope.$on('GoogleMaps:forceResize', function (evt, delay) {
                                if (!delay) {
                                    $timeout(function () {
                                        google.maps.event.trigger(map, "resize");
                                    });
             ...
             */
            /*jshint -W089*/
            app.lazy.directive('mapsEngineLayer', ['Attr2Options', function (Attr2Options) {
                var parser = Attr2Options;
             ...
             *   </map>
             */
            app.lazy.directive('marker', ['Attr2Options', function (Attr2Options) {
                var parser = Attr2Options;
             ...
             */
            /*jshint -W089*/
            app.lazy.directive('overlayMapType', ['Attr2Options', '$window', function (Attr2Options, $window) {
                var parser = Attr2Options;
             ...
             */
            app.lazy.directive('shape', ['Attr2Options', function (Attr2Options) {
                var parser = Attr2Options;
                ...
                return {
                    ...
                    link: function (scope, element, attrs, mapController) {
                        ...
                        if (!!attrs.bindShape && !!attrs.initShape) {
                            scope[attrs.initShape](scope[attrs.bindShape], shape); //.getRadius = function () { return shape.getRadius(); };
                        }
                        /**
                         * set observers
                         */
             ...
             */
            /*jshint -W089*/
            app.lazy.directive('trafficLayer', ['Attr2Options', function (Attr2Options) {
                var parser = Attr2Options;
             ...
             */
            /*jshint -W089*/
            app.lazy.directive('transitLayer', ['Attr2Options', function (Attr2Options) {
                var parser = Attr2Options;
             ...
             */
            /*jshint -W089*/
            app.lazy.directive('weatherLayer', ['Attr2Options', function (Attr2Options) {
                var parser = Attr2Options;
